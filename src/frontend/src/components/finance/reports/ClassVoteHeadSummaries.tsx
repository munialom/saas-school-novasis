// src/components/reports/ClassVoteHeadSummaries.tsx
import React, { useState, useEffect } from 'react';
import { Typography, Space, Button } from 'antd';
import { DatePicker } from 'antd';

import { ReportItem } from "../../../lib/types";
import { getClassSummary } from "../../../lib/api";
...
const ClassVoteHeadSummaries: React.FC<Props> = () => {
    ...
    const fetchReport = async () => {
        ...
        try {
            const response = await getClassSummary(dateRange[0], dateRange[1]);
...
export default ClassVoteHeadSummaries;