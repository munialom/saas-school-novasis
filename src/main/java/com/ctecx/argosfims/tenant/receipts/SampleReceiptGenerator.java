...
public class SampleReceiptGenerator {

    private static final Logger LOGGER = Logger.getLogger(SampleReceiptGenerator.class.getName());
    ...
    public static void main(String[] args) {
        ...
        SampleReceiptGenerator generator = new SampleReceiptGenerator();
