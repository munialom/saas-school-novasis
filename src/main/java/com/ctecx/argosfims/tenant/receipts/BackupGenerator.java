...
public class BackupGenerator {
    ...
    private static final Logger LOGGER = Logger.getLogger(BackupGenerator.class.getName());
    ...
    public static void main(String[] args) {
        ...
        String outputFilename = "School_PaymentVoucher_" + timeStamp + ".pdf";

        Path tempDir = Paths.get(System.getProperty("java.io.tmpdir"));
        Path outputPath = tempDir.resolve(outputFilename);

        BackupGenerator generator = new BackupGenerator();


        // Sample PaymentVoucherDTO (No database)
        ...
        generator.createPaymentVoucherPDF(outputPath.toString(), paymentVoucherDTO);
